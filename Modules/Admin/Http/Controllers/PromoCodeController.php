...
use Modules\Admin\Http\Requests\PromoCodeRequest;
...
class PromoCodeController extends Controller
{
    ...
    */
    ...
    {
       $title=trans('message.promo_code_title');
       return view('admin::promo_code.addedit',compact('title'));
    }
    ...
    {
        $title=trans('message.promo_code_title');
        return view('admin::promo_code.index',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.promo_code_edit');
       $promo_code=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::promo_code.addedit',compact('title','promo_code','encryptedId'));  
    }
