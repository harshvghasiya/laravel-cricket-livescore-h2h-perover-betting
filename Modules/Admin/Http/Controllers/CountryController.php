...
class CountryController extends Controller
{
    ...
    */
    ...
    {
       $title=trans('message.country_title');
       return view('admin::country.addedit',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.country_edit');
       $country=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::country.addedit',compact('title','country','encryptedId'));  
    }
