...
class ContactController extends Controller
{
    ...
    */
    ...
    {
       $title=trans('message.contact_title');
       return view('admin::contact.addedit',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.contact_edit');
       $contact=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::contact.addedit',compact('title','contact','encryptedId'));  
    }
    ...
    */
    public function destroy(Request $request,$id)
    {
     ...
     /**
     * [setMainContact used for set as Main Contact  ]
     * @return [type] [description]
     * @author Softtechover [Harsh V].
    ...
    */
    ...
    {
        return $this->Model->setMainContact($id);
    }
