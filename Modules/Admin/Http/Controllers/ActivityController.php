...
class ActivityController extends Controller
{
    ...
    */
    ...
    public function create()
    {
       ...
       return view('admin::activity.addedit',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.activity_edit');
       $activity=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::activity.addedit',compact('title','activity','encryptedId'));  
    }
