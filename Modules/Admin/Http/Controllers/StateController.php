...
class StateController extends Controller
{
    function __construct()
    {
        ...
        {
            $this->user = \Auth::user();
            if (CHECK_RIGHTS_TO_ACCESS_DENIED(RightModule::CONST_STATE_SETTING, $this->user
            ) )
            {
                return $next($request);
            }
    ...
    */
    ...
    {
       $title=trans('message.state_title');
       return view('admin::state.addedit',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.state_edit');
       $state=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::state.addedit',compact('title','state','encryptedId'));  
    }
