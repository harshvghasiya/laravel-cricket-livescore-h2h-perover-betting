...
class CityController extends Controller
{
    function __construct()
    {
        ...
        {
            $this->user = \Auth::user();
            if (CHECK_RIGHTS_TO_ACCESS_DENIED(RightModule::CONST_CITY_SETTING, $this->user
            ) )
            {
                return $next($request);
            }
    ...
    */
    ...
    /**
     * [getStateDropDown This function is used get state dropdown]
     * @param  Request $request [description]
     * @return [type]           [description]
    ...
    {
        return view('admin::city.partial.state_dropdown',compact('request'));
    }
