...
use Modules\Admin\Http\Requests\ContestRequest;
...
class ContestController extends Controller
{
    ...
    */
    ...
    {
       $title=trans('message.contest_title');
       return view('admin::contest.addedit',compact('title'));
    }
    ...
    {
        $title=trans('message.contest_title');
        return view('admin::contest.index',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.contest_edit');
       $contest=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::contest.addedit',compact('title','contest','encryptedId'));  
    }
