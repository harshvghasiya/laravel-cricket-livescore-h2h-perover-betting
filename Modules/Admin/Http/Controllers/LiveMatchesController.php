...
use Modules\Admin\Http\Requests\LiveMatchRequest;
...
class LiveMatchesController extends Controller
{
    ...
    */
    ...
    {
       $title=trans('message.match_title');
       return view('admin::match.addedit',compact('title'));
    }
    ...
    {
        $title=trans('message.match_title');
        return view('admin::match.index',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.match_edit');
       $match=LiveMatch::with(['match_contest'])->where('id',\Crypt::decrypt($id))->first();
       $encryptedId=$id;
       return view('admin::match.addedit',compact('title','match','encryptedId'));  
    }
