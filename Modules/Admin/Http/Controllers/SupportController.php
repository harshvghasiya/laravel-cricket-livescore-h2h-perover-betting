...
use Modules\Admin\Http\Requests\SupportRequest;
...
class SupportController extends Controller
{
    function __construct()
    {
        ...
        {
            $this->user = \Auth::user();
            if (CHECK_RIGHTS_TO_ACCESS_DENIED(RightModule::CONST_SUPPORT_SETTING, $this->user
            ) )
            {
                return $next($request);
            }
    ...
    */
    ...
    {
       $title=trans('message.support_title');
       return view('admin::support.addedit',compact('title'));
    }
    ...
    */
    ...
    {
       $title=trans('message.support_edit');
       $support=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::support.addedit',compact('title','support','encryptedId'));  
    }
     /**
     * [view used for view admin data ]
     * @return [type] [description]
     * @author Softtechover [Harsh V].
    ...
    */
    ...
    {
       $title=trans('message.support_view');
       $support=$this->Model->getSingleData($id);
       $encryptedId=$id;
       return view('admin::support.view',compact('title','support','encryptedId'));  
    }
    ...
    */
    ...
    /**
     * [markAllAsRead used for all queries set as read ]
     * @return [type] [description]
     * @author Softtechover [Harsh V].
    ...
    */
    public function markAllAsRead(Request $request)
    {
       ...
       return $this->Model->markAllAsRead($request);  
    }
