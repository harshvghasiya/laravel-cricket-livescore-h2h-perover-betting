                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{{trans('message.index_right_breadcrum')}}</li>
                            </ol>
                        </nav>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row m-4">
                            <div class="col-md-6">
                              ...
                              <div class="btn-group">
                                <a href="{{route('admin.right.create')}}" id="sample_editable_1_new" class="btn btn-primary">
                                {{trans('message.add_new')}} 
                                </a>
                              </div>
                              
                                <div class="btn-group">
                                  <a class="btn btn-danger d-none" onclick="deleteAll('table_form','{{route('admin.right.delete_all')}}')">{{trans('message.delete_all_label')}}
                                  </a>
                                </div>
                              @endif
                              <div class="btn-group">
                                <a class="btn btn-warning d-none" style="color: white;" onclick="statusAll('table_form','{{route('admin.right.status_all')}}')">{{trans('message.status_all_label')}}
                                </a>
                              </div>
                            </div>
                        </div>
